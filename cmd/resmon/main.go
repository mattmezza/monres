...
import (
	...
	"github.com/mattmezza/resmon/internal/alerter"
...
func main() {
	flag.Parse()
	log.Println("Starting ResMon Lightweight Resource Monitor...")
	...
	// 2. Initialize Metric History Buffer
	...
	// 3. Initialize Metric Collectors
	...
	// 5. Initialize Alerter (loads initial state itself)
	...
	log.Println("ResMon started. Monitoring resources...")
